...
const TripDetail = ({loaderData}:Route.ComponentProps) => {
    ...
    const {name
      , duration,itinerary,country, travelStyle,groupType, estimatedPrice, description, bestTimeToVisit, weatherInfo,budget, interests
    } = tripData || {}
    ...
    const allTrips = loaderData.trip?.allTrips as Trip[] || []
                ...
                <li className='ml-1'>
                  <ChipListComponent>
                    <ChipsDirective>
                      <ChipDirective
                        text='4.9/5'
                        cssClass='!bg-red-50 !text-yellow-700'
                      />
                    </ChipsDirective>
                  </ChipListComponent>
                </li>
        ...
        <ul className='itinerary'>
          {itinerary?.map((dayPlan: DayPlan, index:number)=>(
            <li key={index}>
              ...
              <ul>
                {dayPlan.activities.map((activity,idex:number)=>(
                  <li key={index}>
